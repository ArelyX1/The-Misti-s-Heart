...
var Audio := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Audio/subsystem_audio.gd").new():
# Careful, this section
	get: return get_subsystem("Audio")

var Backgrounds := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Background/subsystem_backgrounds.gd").new():
	get: return get_subsystem("Backgrounds")

var Portraits := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Character/subsystem_portraits.gd").new():
	get: return get_subsystem("Portraits")

var PortraitContainers := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Character/subsystem_containers.gd").new():
	get: return get_subsystem("PortraitContainers")

var Choices := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Choice/subsystem_choices.gd").new():
	get: return get_subsystem("Choices")

var Expressions := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Core/subsystem_expression.gd").new():
	get: return get_subsystem("Expressions")

var Animations := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Core/subsystem_animation.gd").new():
	get: return get_subsystem("Animations")

var Inputs := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Core/subsystem_input.gd").new():
	get: return get_subsystem("Inputs")

var Glossary := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Glossary/subsystem_glossary.gd").new():
	get: return get_subsystem("Glossary")

var History := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/History/subsystem_history.gd").new():
	get: return get_subsystem("History")

var Jump := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Jump/subsystem_jump.gd").new():
	get: return get_subsystem("Jump")

var Save := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Save/subsystem_save.gd").new():
	get: return get_subsystem("Save")

var Settings := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Settings/subsystem_settings.gd").new():
	get: return get_subsystem("Settings")

var Styles := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Style/subsystem_styles.gd").new():
	get: return get_subsystem("Styles")

var Text := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Text/subsystem_text.gd").new():
	get: return get_subsystem("Text")

var TextInput := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/TextInput/subsystem_text_input.gd").new():
	get: return get_subsystem("TextInput")

var VAR := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Variable/subsystem_variables.gd").new():
	get: return get_subsystem("VAR")

var Voice := preload("res://dialogic-2.0-alpha-16/addons/dialogic/Modules/Voice/subsystem_voice.gd").new():
